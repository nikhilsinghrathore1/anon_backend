...
exports.router.get('/ollama', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const chatCompletion = yield client.chat.completions.create({
                messages: [
                    ...
                    {
                        role: 'user',
                        content: 'Write a lua arweave handler and its corresponsing react code to interact with it on arweave ao chain',
                    },
                ],
                model: 'qwen2.5-coder:latest',
            });
