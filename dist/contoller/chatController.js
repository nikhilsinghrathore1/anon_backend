...
const generateChatResponse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const parsedPrompt = yield JSON.parse(prompt);
        const extractedLatestUserPrompt = yield parsedPrompt[parsedPrompt.length - 1];
        const response = yield (0, ChatService_1.getAiChatResp)(extractedLatestUserPrompt);
